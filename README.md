...
1. - Download “ChemBook-10k” data set from https://pan.baidu.com/s/16dwtyQ2xLUA69whHR906Ug 提取码：x36i;
   - then put it into ChemBook-10k fold;
   - and modify paramenter 'data_name'='ChemBook-10k' in config.py file.
